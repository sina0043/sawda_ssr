import{a as q}from"./chunk-MR6KYNWV.js";import{s as g,y as v}from"./chunk-ZHB5NX4Y.js";import{Fb as l,Gb as d,Hb as m,eb as n,g as y,gc as p,oa as o}from"./chunk-CM677TLH.js";var i=y(q());var T=(()=>{let a=class a{constructor(t){this.browserService=t,this.locations=[[35.3119,46.9964],[35.311152474759936,47.00108613188733],[35.31094235450366,46.986623662207144],[35.320467257721496,46.99349011669805],[35.32689851459618,47.01516109172433],[35.32273183881013,46.97370487083354],[35.338907142943945,46.985120352735905],[35.29982879685737,46.967782552906954],[35.29051163725103,47.021941714167056],[35.2826647761545,46.984777028807514],[35.264235675691154,47.007178837254536],[35.25470415406881,47.030524783101384],[35.31944277648517,47.01636090758903]],this.distanceOption=[],this.closestOptions=[],this.closestOptionsNoRepeat=[],this.closestMarker=[]}ngAfterViewInit(){if(this.browserService.isBrowser()){this.map=i.map("map").setView([35.3119,46.9964],12),i.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:"\xA9 OpenStreetMap"}).addTo(this.map);for(let t=0;t<this.locations.length;t++)i.marker([this.locations[t][0],this.locations[t][1]],{icon:i.divIcon({html:`
